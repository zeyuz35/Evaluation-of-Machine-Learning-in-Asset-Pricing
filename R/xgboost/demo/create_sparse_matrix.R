...
# Let us have a look to the data.table
...
# Let us add some new categorical features to see if it helps. Of course these feature are highly correlated to the Age feature. Usually it is not a good thing in ML, but Tree algorithms (including boosted trees) are able to select the best features, even in case of highly correlated features.
...
# Let us check some Chi2 between each of these features and the outcome.
