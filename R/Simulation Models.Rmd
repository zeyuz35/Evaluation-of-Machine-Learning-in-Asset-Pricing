...
# This model itself is also very very difficult to fit, often running into convergence issues, or taking a very long time
...
# Does suggest that adding in a large number of factors helps
# AIC of -6.041317 for external regressor model
# AIC of -2.5589 for no external regressor model

## Just pretending that constituent models are working for now, moving on to calculating the FFORMA features
