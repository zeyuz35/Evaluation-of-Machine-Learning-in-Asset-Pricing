...
neural_network_2 <- build_NN2()
neural_network_2 %>% summary()

#Just do something straightforward for now

neural_network_2 %>% fit(as.matrix(train_x), as.matrix(train_y), 
                         epochs = 100, verbose = 1, 
                         validation_data = list(as.matrix(validation_x), as.matrix(validation_y)),
                         callbacks = list(early_stop))
...
NN2_predictions <- neural_network_2 %>% predict(as.matrix(test_x))

mae(test$rt, NN1_predictions)
mse(test$rt, NN1_predictions)
```
...
neural_network_3 <- build_NN3()
neural_network_3 %>% summary()

#Just do something straightforward for now

neural_network_3 %>% fit(as.matrix(train_x), as.matrix(train_y), 
                         epochs = 100, verbose = 1, 
                         validation_data = list(as.matrix(validation_x), as.matrix(validation_y)),
                         callbacks = list(early_stop))
...
NN3_predictions <- neural_network_3 %>% predict(as.matrix(test_x))

mae(test$rt, NN3_predictions)
mse(test$rt, NN3_predictions)
```
...
neural_network_4 <- build_NN4()
neural_network_4 %>% summary()

#Just do something straightforward for now

neural_network_4 %>% fit(as.matrix(train_x), as.matrix(train_y), 
                         epochs = 100, verbose = 1, 
                         validation_data = list(as.matrix(validation_x), as.matrix(validation_y)),
                         callbacks = list(early_stop))
...
NN4_predictions <- neural_network_4 %>% predict(as.matrix(test_x))

mae(test$rt, NN4_predictions)
mse(test$rt, NN4_predictions)
```
...
neural_network_5 <- build_NN5()
neural_network_5 %>% summary()

#Just do something straightforward for now

neural_network_5 %>% fit(as.matrix(train_x), as.matrix(train_y), 
                         epochs = 100, verbose = 1, 
                         validation_data = list(as.matrix(validation_x), as.matrix(validation_y)),
                         callbacks = list(early_stop))
...
NN5_predictions <- neural_network_5 %>% predict(as.matrix(test_x))

mae(test$rt, NN5_predictions)
mse(test$rt, NN5_predictions)
```
