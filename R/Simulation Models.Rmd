...
# These parameters give you teh following train/validation/test splits (in terms of years)
# 7 3 3
# 8 3 3
# 9 3 3
...
NNet_1_mse_stats <- NNet_fit_stats(pooled_panel, timeSlices, 1, "mse", batch_size = 256, 5)
NNet_1_mae_stats <- NNet_fit_stats(pooled_panel, timeSlices, 1, "mae", batch_size = 32, 5)
