...
ELN_grid <- expand.grid(
  alpha = seq(0, 1, 0.1),
  lambda = 10^seq(-3, 5, length.out = 10)
)
...
ELN_stats <- function(ELN_grid, timeSlices, pooled_panel, loss_function) {
...
ELN_stats <- ELN_stats(ELN_grid, timeSlices, pooled_panel, loss_function = "mse")
