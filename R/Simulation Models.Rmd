...
lstm_model %>% fit(X_array, Y_array, epochs = 50,
...
stock_1_train_pca <- prcomp(stock_1_train[, -(1:3)], center = TRUE, scale. = TRUE, tol = 0.5)
...
# Need param data - a matrix of the input features data (tsfeatures), one observation (time series) per row
# need param errors, a matrix of with the forecast errors, each row being a vector of the rrors of the forecasting methods
# Need param labels - a numeric vector from 0 to nclass - 1 with the target labels for classification
```
