...
## Does not seem to be an easy way to choose which "sub method" is the best, just doing it manually from viewing above
...
## They do not look incredibly consistent at first, but realise that these are the raw vimps which have no been normalised
