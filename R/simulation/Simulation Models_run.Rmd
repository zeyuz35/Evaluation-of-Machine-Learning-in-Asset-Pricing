...
fit_all_models <- function(dataset_list, batch_process_range,
                           ...
                           # This is useful if you do not want to fit some of the most intensive methods such as RF and Neural Networks
                           LM, ELN, RF, NNet) {
  # Initialize List
  ...
  for (batch in (batch_process_range)) {
    ...
    if (NNet == 1) {
      # Neural Networks
      # Commented for now because honours lab computers do not have keras/tensorflow
...
## nosv_0
## Do not bother with this design because it's stupid, and was only done just to replicate Gu's experiments
