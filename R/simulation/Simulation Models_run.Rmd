...
fit_all_models <- function(dataset_list, batch_process_range,
                           ...
                           # This is useful if fitting computationally intensive methods (such as RF and Neural Networks) is not desired
                           LM, ELN, RF, NNet) {
  # Initialize List
  ...
  for (batch in (batch_process_range)) {
    ...
    if (NNet == 1) {
      # Neural Networks
      # Commented for now because local environments lack keras/tensorflow
...
## nosv_0
## Omit this design; it is inefficient and was implemented solely to replicate Gu's experiments
