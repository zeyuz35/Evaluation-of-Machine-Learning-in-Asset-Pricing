...
# ELN is rather sensitive and likes to generate its own sequence of lambda values during the actual fitting process. Really does not like specifying a singular lambda value
...
# Remeber that this function does not do train/validation/split, so you will have to do these outside of it
