...
ggsave(filename= "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/Results/empirical_train_valid_1/empirical_all_sample_vi_macro.pdf", 
       width = 8, height = 5, units = "cm")

empirical_vi_ind_plot + empirical_vi_macro_plot +
  plot_layout(guides = 'collect') +
  plot_layout(widths = c(2, 1))
ggsave(filename= "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/Results/empirical_train_valid_1/empirical_all_sample_vi.pdf", width = 18, height = 9, units = "cm")
