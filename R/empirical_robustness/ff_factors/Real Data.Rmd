...
get_ELN_best_tune <- function(model_grid) {
  ELN_tune_dataframe <- do.call(rbind, lapply(seq_along(model_grid), function(i) {
    cbind(model_grid[[i]]$ELN_grid, list_index = i)
  }))
  ELN_tune_dataframe <- as.data.frame(ELN_tune_dataframe)
...
get_RF_best_tune <- function(RF_model_grid) {
  RF_tune_grid <- do.call(rbind, lapply(RF_model_grid, `[[`, "RF_grid"))
