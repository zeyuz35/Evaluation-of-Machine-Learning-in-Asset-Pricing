...
get_ELN_best_tune <- function(model_grid) {
  list_df <- lapply(seq_along(model_grid), function(i) {
    cbind(model_grid[[i]]$ELN_grid, list_index = i)
  })
  ELN_tune_dataframe <- do.call(rbind, list_df)
...
get_RF_best_tune <- function(RF_model_grid) {
  list_df <- lapply(seq_along(RF_model_grid), function(i) {
    RF_model_grid[[i]]$RF_grid
  })
  RF_tune_grid <- do.call(rbind, list_df)
