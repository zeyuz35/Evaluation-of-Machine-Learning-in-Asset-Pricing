...
datashare_RAW <- read_csv("~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/data/datashare/datashare.csv",
                          # Always make sure to force col_types so that read_csv does not assume incorrect structures
...
# Lots of different approaches, we will stick with the rank transformation of only the individual charcteristics for each cross section and leave the macro economic factors untouched
