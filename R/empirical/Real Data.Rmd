...
LM_stats_mse <- LM_fit(final_dataset, realdata_timeSlices, "mse", f,
                       macro_factor_names, individual_factor_names)
saveRDS(LM_stats_mae, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/empirical/LM_stats_mae.rds")

LM_stats_mae <- LM_fit(final_dataset, realdata_timeSlices, "mae", f,
                       macro_factor_names, individual_factor_names)
saveRDS(LM_stats_mse, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/empirical/LM_stats_mse.rds")
