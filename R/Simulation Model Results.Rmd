...
fit_all_models <- function(dataset_list, batch_process_range,
  ...
  for (batch in (batch_process_range)) {
    ...
    if (RF == 1) {
      ...
      simulation_results_list[[batch]]$RF_MSE <- RF_fit_stats(pooled_panel, RF_grid, timeSlices, "mse")
      simulation_results_list[[batch]]$RF_MAE <- RF_fit_stats(pooled_panel, RF_grid, timeSlices, "mae")
    }
...
gu_et_al_g1_results <- fit_all_models(gu_et_al_g1, batch_process_range, LM = 1, ELN = 0, RF = 0, NNet = 1)
gu_et_al_g2_results <- fit_all_models(gu_et_al_g2, batch_process_range, LM = 1, ELN = 0, RF = 0, NNet = 1)

g1_A1 <- fit_all_models(g1_A1_panel, batch_process_range, LM = 1, ELN = 1, RF = 1, NNet = 1)
