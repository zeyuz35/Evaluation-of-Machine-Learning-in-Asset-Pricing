...
g1_A1 <- fit_all_models(g1_A1_panel, batch_process_range, LM = 1, ELN = 0, RF = 0, NNet = 1)
...
gu_et_al_g2_results_importance <- combined_importance_list(gu_et_al_g2_results)

combined_importance_plot(gu_et_al_g2_results_importance, 1, 3, 0.005)
