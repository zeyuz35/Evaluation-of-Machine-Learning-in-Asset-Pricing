...
ggsave(filename = "simulation_train_mae.pdf")
...
all_loss_df_averaged %>%
  ...
  scale_fill_brewer(palette = "Paired") +
  facet_grid(rows = vars(cross_corr), cols = vars(dgp_spec))
ggsave(filename = "simulation_train_mse.pdf")
...
all_loss_df_averaged %>%
  ...
  scale_fill_brewer(palette = "Paired") +
  facet_grid(rows = vars(cross_corr), cols = vars(dgp_spec))
ggsave(filename = "simulation_train_rsquare.pdf")
...
all_loss_df_averaged %>%
  ...
  scale_fill_brewer(palette = "Paired") +
  facet_grid(rows = vars(cross_corr), cols = vars(dgp_spec))
ggsave(filename = "simulation_test_mae.pdf")
...
all_loss_df_averaged %>%
  ...
  scale_fill_brewer(palette = "Paired") +
  facet_grid(rows = vars(cross_corr), cols = vars(dgp_spec))
ggsave(filename = "simulation_test_mse.pdf")
...
all_loss_df_averaged %>%
  ...
  scale_fill_brewer(palette = "Paired") +
  facet_grid(rows = vars(cross_corr), cols = vars(dgp_spec))
ggsave(filename = "simulation_test_rsquare.pdf")
```
...
ggsave("simulation_g1_vi_plot.pdf")
...
g2_vi_plot <- all_vi_df_averaged %>%
  ...
  # Facet
  facet_grid(rows = vars(cross_corr), cols = vars(sample))
ggsave("simulation_g2_vi_plot.pdf")
...
g3_vi_plot <- all_vi_df_averaged %>%
  ...
  # Facet
  facet_grid(rows = vars(cross_corr), cols = vars(sample))
ggsave("simulation_g3_vi_plot.pdf")
