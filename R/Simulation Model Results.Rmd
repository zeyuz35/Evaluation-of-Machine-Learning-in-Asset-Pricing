...
normalize_variable_importance <- function(variable_importance_df) {
  min <- min(variable_importance_df$importance)
  sum <- sum(variable_importance_df$importance + min)
  variable_importance_df %>%
    mutate(importance = importance + min) %>%
    mutate(importance = importance/sum)
}
