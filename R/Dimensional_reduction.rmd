...
## Applying UMAP on the entire pooled panel vs just a single univariate series seems to give very similar results, once you filter to a univariate series
## Suggestion to apply UMAP on entire series first, as this is computationally more efficient
