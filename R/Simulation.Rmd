...
g1_A1_panel <- sim_panel_data(simN, 
                              ...
                              cross_corr = 1, A1, xt_multi = 1, g_function = "g1", theta = matrix(c(0.015, 0.015, 0.015), nrow = 1), 
                              error_sv = 1, error_ep_sd = 1, 
                              error_omega = -1.2, error_gamma = 0.95, error_w = 0.2, error_v_sd = 0.05,
                              predictor_format = "kronecker")
...
g2_A1_panel <- sim_panel_data(simN, 
                              ...
                              error_sv = 1, error_ep_sd = 1, 
                              error_omega = -1.0, error_gamma = 0.95, error_w = 0.2, error_v_sd = 0.05,
                              predictor_format = "kronecker")
