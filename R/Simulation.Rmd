...
g1_A1_panel <- sim_panel_data(simN, 
                              ...
                              cross_corr = 0, A1, xt_multi = 1, g_function = "g1", theta = matrix(c(0.007, 0.007, 0.007), nrow = 1), 
...
g1_A2_panel <- sim_panel_data(simN, 
                              char_rho_a = 0.5, char_rho_b = 1,
                              cross_corr = 0, A2, xt_multi = 1, g_function = "g1", theta = matrix(c(0.007, 0.007, 0.007), nrow = 1), 
                              error_sv = 1, error_ep_sd = 0.05, 
                              error_omega = -0.736, error_gamma = 0.9, error_w = sqrt(0.363), error_v_sd = 0.05,
                              predictor_format = "kronecker")
...
g2_A2_panel <- sim_panel_data(simN, 
                              char_rho_a = 0.5, char_rho_b = 1,
                              cross_corr = 1, A2, xt_multi = 1, g_function = "g2", theta = matrix(c(0.04, 0.035, 0.01), nrow = 1),
                              error_sv = 1, error_ep_sd = 0.05, 
                              error_omega = -0.736, error_gamma = 0.9, error_w = sqrt(0.363), error_v_sd = 0.05,
                              predictor_format = "kronecker")
...
g2_A3_panel <- sim_panel_data(simN, 
                              char_rho_a = 0.5, char_rho_b = 1,
                              cross_corr = 1, A3, xt_multi = 1, g_function = "g2", theta = matrix(c(0.04, 0.035, 0.01), nrow = 1),
                              error_sv = 1, error_ep_sd = 0.05, 
                              error_omega = -0.736, error_gamma = 0.9, error_w = sqrt(0.363), error_v_sd = 0.05,
                              predictor_format = "kronecker")
...
g3_A1_panel <- sim_panel_data(simN, 
                              char_rho_a = 0.5, char_rho_b = 1,
                              cross_corr = 0, A1, xt_multi = 0, g_function = "g3", theta = matrix(c(0.015, 0.015, 0.015, 0.02), nrow = 1), 
                              error_sv = 1, error_ep_sd = 0.05, 
                              error_omega = -0.736, error_gamma = 0.9, error_w = sqrt(0.363), error_v_sd = 0.05,
                              predictor_format = "kronecker")
...
g3_A2_panel <- sim_panel_data(simN, 
                              char_rho_a = 0.5, char_rho_b = 1,
                              cross_corr = 1, A2, xt_multi = 1, g_function = "g3", theta = matrix(c(0.02, 0.02, 0.02, 0.02), nrow = 1), 
                              error_sv = 1, error_ep_sd = 0.05, 
                              error_omega = -0.736, error_gamma = 0.9, error_w = sqrt(0.363), error_v_sd = 0.05,
                              predictor_format = "kronecker")
...
g3_A3_panel <- sim_panel_data(simN, 
                              char_rho_a = 0.5, char_rho_b = 1,
                              cross_corr = 1, A3, xt_multi = 1, g_function = "g3", theta = matrix(c(0.02, 0.02, 0.02, 0.02), nrow = 1), 
                              error_sv = 1, error_ep_sd = 0.05, 
                              error_omega = -0.736, error_gamma = 0.9, error_w = sqrt(0.363), error_v_sd = 0.05,
                              predictor_format = "kronecker")
