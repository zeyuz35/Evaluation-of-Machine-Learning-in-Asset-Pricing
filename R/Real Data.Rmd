...
datashare <- datashare_RAW %>%
  ...
  # Filter so that only much recent data is used
  # Not too sure which exact periods, but for now, 2000 to 2015
  filter(Time >= as.yearmon("2000-01") & Time <= as.yearmon("2015-01"))
...
# Wait, not too sure about this yet because Gu et al later later a singular sic2 importance metric
