...
NNet_fit_stats <- function(pooled_panel, timeSlices, hidden_layers, loss_function, batch_size, patience,
  ...
  for (set in 1:3) {
    ...
    lr_reduce <- callback_reduce_lr_on_plateau(monitor = "val_loss", factor = 0.1,
    ...
    neural_network %>% fit(as.matrix(train_x), as.matrix(train_y), 
                           ...
                           callbacks = list(early_stop, lr_reduce, print_dot_callback))
...
LM_stats_mae <- LM_fit(final_dataset, realdata_timeSlices, "mse", f,
                       macro_factor_names, individual_factor_names)
...
NNet_1_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 1, "mse", batch_size = 128, 40,
                                   macro_factor_names, individual_factor_names)
NNet_1_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 1, "mae", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)

NNet_2_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 2, "mse", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)
NNet_2_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 2, "mae", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)

NNet_3_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 3, "mse", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)
NNet_3_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 3, "mae", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)

NNet_4_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 4, "mse", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)
NNet_4_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 4, "mae", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)

NNet_5_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 5, "mse", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)
NNet_5_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 5, "mae", batch_size = 128, 50,
                                   macro_factor_names, individual_factor_names)
