...
saveRDS(LM_stats_mae, file = "LM_stats_mae.rds")
saveRDS(LM_stats_mse, file = "LM_stats_mse.rds")
...
saveRDS(ELN_stats_mse, file = "ELN_stats_mse.rds")
saveRDS(ELN_stats_mae, file = "ELN_stats_mae.rds")
...
saveRDS(RF_mse_stats, file = "RF_mse_stats_1.5_train_valid.rds")

saveRDS(RF_mae_stats, file = "RF_mae_stats_1.5_train_valid.rds")
...
saveRDS(NNet_1_mse_stats, file = "NNet_1_mse_stats_1.5.rds")
saveRDS(NNet_1_mae_stats, file = "NNet_1_mae_stats_1.5.rds")
...
saveRDS(NNet_2_mse_stats, file = "NNet_2_mse_stats_1.5.rds")
saveRDS(NNet_2_mae_stats, file = "NNet_2_mae_stats_1.5.rds")
...
saveRDS(NNet_3_mse_stats, file = "NNet_3_mse_stats_1.5.rds")
saveRDS(NNet_3_mae_stats, file = "NNet_3_mae_stats_1.5.rds")
...
saveRDS(NNet_4_mse_stats, file = "NNet_4_mse_stats_1.5.rds")
saveRDS(NNet_4_mae_stats, file = "NNet_4_mae_stats_1.5.rds")
...
saveRDS(NNet_5_mse_stats, file = "NNet_5_mse_stats_1.5.rds")
saveRDS(NNet_5_mae_stats, file = "NNet_5_mae_stats_1.5.rds")
...
NNet_2_mae_stats <- readRDS("NNet_2_mae_stats_1.5.rds")

NNet_3_mse_stats <- readRDS("NNet_3_mse_stats_1.5.rds")
NNet_3_mae_stats <- readRDS("NNet_3_mae_stats_1.5.rds")

NNet_4_mse_stats <- readRDS("NNet_4_mse_stats_1.5.rds")
NNet_4_mae_stats <- readRDS("NNet_4_mae_stats_1.5.rds")

NNet_5_mse_stats <- readRDS("NNet_5_mse_stats_1.5.rds")
NNet_5_mae_stats <- readRDS("NNet_5_mae_stats_1.5.rds")
```
...
write.csv(empirical_results_df, file = "empirical_results.csv")
...
ggsave(filename = "empirical_test_mae.pdf")
...
empirical_results_df %>%
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  scale_fill_brewer(palette = "Paired")
ggsave(filename = "empirical_test_mse.pdf")
...
empirical_results_df %>%
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  scale_fill_brewer(palette = "Paired")
ggsave(filename = "empirical_test_rsquare.pdf")
####
# Training Statistics
...
empirical_results_df %>%
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  scale_fill_brewer(palette = "Paired")
ggsave(filename = "empirical_train_mae.pdf")
...
empirical_results_df %>%
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  scale_fill_brewer(palette = "Paired")
ggsave(filename = "empirical_train_mse.pdf")
...
empirical_results_df %>%
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  scale_fill_brewer(palette = "Paired")
ggsave(filename = "empirical_train_rsquare.pdf")
...
write.csv(empirical_tidy_vi, file = "empirical_tidy_vi.csv")
...
ggsave(filename= "empirical_sample_1_vi.pdf", width = 15, height = 15 * a4_aspect_ratio, units = "cm")
...
ggsave(filename= "empirical_sample_2_vi.pdf", width = 15, height = 15 * a4_aspect_ratio, units = "cm")
...
ggsave(filename= "empirical_sample_3_vi.pdf", width = 15, height = 15 * a4_aspect_ratio, units = "cm")
