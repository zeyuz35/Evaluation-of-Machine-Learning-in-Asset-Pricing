...
NNet_1_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 1, "mse", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)
NNet_1_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 1, "mae", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)

NNet_2_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 2, "mse", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)
NNet_2_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 2, "mae", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)

NNet_3_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 3, "mse", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)
NNet_3_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 3, "mae", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)

NNet_4_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 4, "mse", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)
NNet_4_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 4, "mae", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)

NNet_5_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 5, "mse", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)
NNet_5_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 5, "mae", batch_size = 512, 50,
                                   macro_factor_names, individual_factor_names)
