...
datashare_combined <- full_join(macro_predictors, datashare_imputed, by = "time") %>%
...
realdata_timeSlices <- realdata_custom_timeslices(
  start = 1993.5, initialWindow = 11, horizon = 1, validation_size = 8, test_size = 1, set_no = 3
  )
```
...
saveRDS(LM_stats_mae, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/LM_stats_mae.rds")
saveRDS(LM_stats_mse, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/LM_stats_mse.rds")
...
saveRDS(ELN_stats_mse, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/ELN_stats_mse.rds")
saveRDS(ELN_stats_mae, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/ELN_stats_mae.rds")
...
saveRDS(RF_mse_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/RF_mse_stats_1.5_train_valid.rds")

saveRDS(RF_mae_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/RF_mae_stats_1.5_train_valid.rds")
...
saveRDS(NNet_1_mse_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_1_mse_stats_1.5.rds")
saveRDS(NNet_1_mae_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_1_mae_stats_1.5.rds")
...
saveRDS(NNet_2_mse_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_2_mse_stats_1.5.rds")
saveRDS(NNet_2_mae_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_2_mae_stats_1.5.rds")
...
saveRDS(NNet_3_mse_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_3_mse_stats_1.5.rds")
saveRDS(NNet_3_mae_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_3_mae_stats_1.5.rds")

NNet_4_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 4, "mse", batch_size = 256, 50,
                                   macro_factor_names, individual_factor_names)
NNet_4_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 4, "mae", batch_size = 256, 50,
                                   macro_factor_names, individual_factor_names)
...
saveRDS(NNet_4_mse_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_4_mse_stats_1.5.rds")
saveRDS(NNet_4_mae_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_4_mae_stats_1.5.rds")

NNet_5_mse_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 5, "mse", batch_size = 256, 50,
                                   macro_factor_names, individual_factor_names)
NNet_5_mae_stats <- NNet_fit_stats(final_dataset, realdata_timeSlices, 5, "mae", batch_size = 256, 50,
                                   macro_factor_names, individual_factor_names)
...
saveRDS(NNet_5_mse_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_5_mse_stats_1.5.rds")
saveRDS(NNet_5_mae_stats, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/R/Model_results/NNet_5_mae_stats_1.5.rds")
...
empirical_results_df <- foreach(sample = (1:3), .combine = "rbind") %do% {
  cbind(Sample = sample, 
    rbind(
      ...
      cbind(model = "NNet_1_MSE", NNet_1_mse_stats[[sample]]$loss_stats),
      cbind(model = "NNet_1_MAE", NNet_1_mae_stats[[sample]]$loss_stats),
      
      cbind(model = "NNet_2_MSE", NNet_2_mse_stats[[sample]]$loss_stats),
      cbind(model = "NNet_2_MAE", NNet_2_mae_stats[[sample]]$loss_stats),
      
      cbind(model = "NNet_3_MSE", NNet_3_mse_stats[[sample]]$loss_stats),
      cbind(model = "NNet_3_MAE", NNet_3_mae_stats[[sample]]$loss_stats),
      
      cbind(model = "NNet_4_MSE", NNet_4_mse_stats[[sample]]$loss_stats),
      cbind(model = "NNet_4_MAE", NNet_4_mae_stats[[sample]]$loss_stats),
      
      cbind(model = "NNet_5_MSE", NNet_5_mse_stats[[sample]]$loss_stats),
      cbind(model = "NNet_5_MAE", NNet_5_mae_stats[[sample]]$loss_stats)
    )
  )
}

# Function to export something to latex format
export_latex <- function(x, file) {
  print(xtable(x), type="latex", file=paste0(deparse(substitute(x)), ".tex"))
}

write.csv(empirical_results_df, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/Results/empirical_results.csv")
export_latex(empirical_results_df, 
...
empirical_tidy_vi <- foreach(sample = 1:3, .combine = "rbind") %do% {
    rbind(
...
write.csv(empirical_tidy_vi, file = "~/GitHub/Evaluation-of-Machine-Learning-in-Asset-Pricing/Results/empirical_tidy_vi.csv")
