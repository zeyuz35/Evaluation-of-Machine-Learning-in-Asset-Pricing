...
\begin{figure}[!htb]
	\centering
	\includegraphics[max size = {\textwidth}{0.35\textheight}]{../../Results/empirical/empirical_all_sample_vi_ind.pdf}
...
\begin{figure}[!htb]
	...
	\centering
	\includegraphics[max size = {\textwidth}{0.35\textheight}]{../../Results/empirical/empirical_all_sample_vi_macro.pdf}
