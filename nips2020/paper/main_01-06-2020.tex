...
Random forests, and to a lesser extent neural networks, can also correctly identified the correct underlying regressors, but struggled with adequately discerning relative importance among correlated regressors. This behavior becomes more pronounced as the degree of cross-sectional correlation increases (see decreasing relative importance of true underlying regressors in Figure \ref{fig:VIs}).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Individual factor name table
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

	\footnotetext{The factor was included in the original dataset provided by \cite{gu_empirical_2019}, but was not used due to missing data issues.}
	\begin{center}
		\fontsize{6}{8}\selectfont
		\label{ind_factors}
...
\begin{figure}
	...
	\caption{Train:Validation = 1:2 Robustness Check Individual Factor Importance}
\end{figure}

%% RF Vimps
\begin{figure}
	\includegraphics[max size = {\textwidth}{0.25\textheight}]{../../Results/empirical_train_valid_2/empirical_vimp.pdf}
	\caption{Train:Validation = 1:2 Robustness Check RF VIMP}
\end{figure}
\FloatBarrier
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Fama French Factors
