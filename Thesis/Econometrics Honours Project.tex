...
\begin{table}
	...
	\begin{center}
		\begin{longtable}{lllllllll} \hline \hline
			...
			\endfoot
			\endlastfoot
			1 & absacc & Absolute Accruals & \cite{bandyopadhyay_accrual_nodate} & year & Continuous & Compustat & Annual \\
			...
			4 & age & \# years since first Compustat coverage & cite & year & Continuous & Compustat & Annual \\
			5 & agr & Asset growth & \cite{cooper_asset_2008} & year & Continuous & Compustat & Annual \\
			6 & baspread & Bid-ask spread & cite & year & Continuous & Compustat & Monthly \\
			7 & beta & Beta & cite & year & Continuous & Compustat & Monthly \\
			8 & betasq & Beta squared & cite & year & Continuous & Compustat & Monthly \\
			...
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			11 & cash & Cash holdings & cite & year & Continuous & Compustat & Annual \\
			12 & cashdebt & Cash 
			ow to debt & cite & year & Continuous & Compustat & Annual \\
			13 & cashpr & Cash productivity & \cite{chandrashekar_productivity_2009} & year & Continuous & Compustat & Annual \\
			14 & cfp & Cashflow to price ratio & cite & year & Continuous & Compustat & Annual \\
			15 & cfp\_ia & Industry-adjusted cash 
			ow to price ratio & \cite{asness_predicting_2000} & year & Continuous & Compustat & Annual \\
			...
			18 & chempia & Industry-adjusted change in employee & cite & year & Continuous & Compustat & Annual \\
			...
			23 & cinvest & Corporate investment & cite & year & Continuous & Compustat & Quarterly \\
			24 & convind & Convertible debt indicator & cite & year & Dummy & Compustat & Annual \\
			25 & currat & Current ratio & cite & year & Continuous & Compustat & Annual \\
			26 & depr & Depreciation / PP\&E & cite & year & Continuous & Compustat & Annual \\
			27 & divi & Dividend initiation & cite & year & Dummy & Compustat & Annual \\
			28 & divo & Dividend omission & cite & year & Dummy & Compustat & Annual \\
			29 & dolvol & Dollar trading volume & \cite{chordia_trading_2001} & year & Continuous & Compustat & Monthly \\
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			30 & dy & Dividend to price & cite & year & Continuous & Compustat & Annual \\
			31 & ear & Earnings announcement return & cite & year & Continuous & Compustat & Quarterly \\ \hline
			...
			35 & grCAPX & Growth in capital expenditures & cite & year & Continuous & Compustat & Annual \\
			36 & grltnoa & Growth in long term net operating assets & cite & year & Continuous & Compustat & Annual \\
			...
			39 & idiovol & Idiosyncratic return volatility & cite & year & Continuous & Compustat & Monthly \\
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			40 & ill & Illiquidity & cite & year & Continuous & Compustat & Monthly \\
			41 & indmom & Industry momentum & cite & year & Continuous & Compustat & Monthly \\
			42 & invest & Capital expenditures and inventory & \cite{chen_better_2010} & year & Continuous & Compustat & Annual \\
			43 & lev & Leverage & cite & year & Continuous & Compustat & Annual \\
			...
			46 & mom12m & 12-month momentum & cite & year & Continuous & Compustat & Monthly \\
			...
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			50 & ms & Financial statement score & cite & year & Continuous & Compustat & Quarterly \\
			...
			53 & nincr & Number of earnings increases & cite & year & Categorical & Compustat & Quarterly \\
			54 & operprof & Operating protability & cite & year & Continuous & Compustat & Annual \\
			55 & orgcap & Organizational capital & cite & year & Continuous & Compustat & Annual \\
			56 & pchcapx\_ia & Industry adjusted \% change in capital expenditures & cite & year & Continuous & Compustat & Annual \\
			57 & pchcurrat & \% change in current ratio & cite & year & Continuous & Compustat & Annual \\
			58 & pchdepr & \% change in depreciation & cite & year & Continuous & Compustat & Annual \\
			59 & pchgm\_pchsale & \% change in gross margin - \% change in sales & cite & year & Continuous & Compustat & Annual \\ \hline
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			60 & pchquick & \% change in quick ratio & cite & year & Continuous & Compustat & Annual \\
			61 & pchsale\_pchinvt & \% change in sales - \% change in inventory & cite & year & Continuous & Compustat & Annual \\
			62 & pchsale\_pchrect & \% change in sales - \% change in A/R & cite & year & Continuous & Compustat & Annual \\
			63 & pchsale\_pchxsga & \% change in sales - \% change in SG&A & cite & year & Continuous & Compustat & Annual \\
			64 & pchsaleinv & \% change sales-to-inventory & cite & year & Continuous & Compustat & Annual \\
			65 & pctacc & Percent accruals & \cite{hafzalla_percent_2011} & year & Continuous & Compustat & Annual \\
			66 & pricedelay & Price delay & cite & year & Continuous & Compustat & Monthly \\
			67 & ps & Financial statements score & cite & year & Categorical & Compustat & Annual \\
			68 & quick & Quick ratio & cite & year & Continuous & Compustat & Annual \\
			69 & rd & R\&D increase & \cite{eberhart_examination_2004} & year & Continuous & Compustat & Annual \\ \hline
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			70 & rd\_mve & R\&D to market capitalization & cite & year & Continuous & Compustat & Annual \\
			71 & rd\_sale & R\&D to sales & cite & year & Continuous & Compustat & Annual \\
			72 & realestate & Real estate holdings & cite & year & Continuous & Compustat & Annual \\
			...
			76 & roeq & Return on equity & cite & year & Continuous & Compustat & Quarterly \\
			...
			79 & salecash & Sales to cash & cite & year & Continuous & Compustat & Annual \\ \hline
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			80 & saleinv & Sales to inventory & cite & year & Continuous & Compustat & Annual \\
			81 & salerec & Sales to receivables & cite & year & Continuous & Compustat & Annual \\
			82 & secured & Secured debt & cite & year & Continuous & Compustat & Annual \\
			83 & securedind & Secured debt indicator & cite & year & Dummy & Compustat & Annual \\
			84 & sgr & Sales growth & cite & year & Continuous & Compustat & Annual \\
			85 & sin & Sin stocks & cite & year & Dummy & Compustat & Annual \\
			86 & sp & Sales to price & cite & year & Continuous & Compustat & Annual \\
			...
			91 & tang & Debt capacity/rm tangibility & cite & year & Continuous & Compustat & Quarterly \\
			...
			94 & zerotrade & Zero trading days & cite & year & Continuous & Compustat & Monthly \\	
		\end{longtable}
	\end{center}
\end{table}
