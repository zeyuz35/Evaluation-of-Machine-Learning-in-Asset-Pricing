%Preamble
\documentclass[man, a4paper, biblatex]{article}
...
\begin{flalign*}
(1)\; & g\left(z_{i, t}\right)=\left(c_{i 1, t}, c_{i 2, t}, c_{i 3, t} \times x_{t}'\right) \theta_{0};
\quad \text { where } \theta_{0} = (0.02, 0.02, 0.02)^{\prime}\\
(2)\;&g\left(z_{i, t}\right)=\left(c_{i 1, t}^{2}, c_{i 1, t} \times c_{i 2, t}, \operatorname{sgn}\left(c_{i 3, t} \times  x_{t}'\right)\right) \theta_{0}; 
\quad \text { where } \; \theta_{0} = (0.04, 0.035, 0.01)^{\prime} \\
(3)\; & g\left(z_{i, t}\right) = \left(1[c_{i3,t}>0],c_{i 2, t}^{3}, c_{i 1, t} \times c_{i 2, t}\times 1[c_{i3,t}>0], \text{logit}\left({c}_{i 3, t} \right)\right) \theta_{0};
\quad \text { where } \theta_{0} = (0.04, 0.035, 0.01, 0.01)^{\prime}  \\
(4)\; &g\left(z_{i, t}\right)=\left(\hat{c}_{i 1, t}, \hat{c}_{i 2, t}, \hat{c}_{i 3, t} \times x_{t}'\right) \theta_{0};
\quad \text { where } \theta_{0} = (0.02 ,0.02 ,0.02)^{\prime}
\end{flalign*}
...
The Diebold-Mariano test is a procedure which tests whether or not the forecasts between two different models are significantly different.  
