...
\begin{itemize}
	\item Simulating individual firm and macroeconomic factors
	\item Entering these factors into a latent, true data generating process
	\item Producing the overall returns process as this latent process plus an error process
\end{itemize}
