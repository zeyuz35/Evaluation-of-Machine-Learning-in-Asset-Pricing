...
\begin{figure}
	...
	\begin{center}
		\includegraphics[max size = {\textwidth}{\textheight}]{simulation_test_mae.pdf}
		\includegraphics[max size = {\textwidth}{\textheight}]{simulation_test_mse.pdf}
		\caption{Simulation Test Loss Metrics}
	\end{center}
\end{figure}
...
\begin{figure}
	\begin{center}
	\includegraphics[max size = {\textwidth}{\textheight}]{empirical_sample_1_vi_ind.pdf}
	\end{center}
...
\begin{figure}
	\begin{center}
	\includegraphics[max size = {\textwidth}{\textheight}]{empirical_sample_2_vi_ind.pdf}
	\end{center}
...
\begin{figure}
	\begin{center}
	\includegraphics[max size = {\textwidth}{\textheight}]{empirical_sample_3_vi_ind.pdf}
	\end{center}
