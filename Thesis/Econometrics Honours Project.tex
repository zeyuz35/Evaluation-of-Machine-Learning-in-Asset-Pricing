...
Interestingly, all models considered typically preferred extremely sparse parameterizations. That is, most if not all of the individual factors had little to no importance across all models. When looking at macroeconomic variables, all models tend to produce inconsistent importance measures when compared. Penalized linear models tend to identify the average book to market ratio
