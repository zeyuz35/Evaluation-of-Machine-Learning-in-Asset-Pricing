...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[max size = {\textwidth}{0.5\textheight}]{simulation_test_mae_pre.pdf}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[max size = {\textwidth}{0.5\textheight}]{simulation_test_mse_pre.pdf}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[max size = {\textwidth}{0.5\textheight}]{simulation_test_rsquare_pre.pdf}
		\caption{Simulation Test OOS R Squared, only including best performing Neural Networks}
	\end{center}
\end{figure}

\rhs{this point is important, emphasize a bit more}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[max size = {\textwidth}{0.5\textheight}]{simulation_test_rsquare_small_nn.pdf}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[max size = {20cm}{20cm}]{simulation_ave_vi_plot.pdf}
...
We conduct an empirical study to validate and check the robustness of the results observed in the simulation study. Though our simulation study was aimed at capturing the main characteristics of empirical data, the underlying data generating process for empirical returns is unknown this thus as a robustness check as to how machine learning performs on real world data, which can be significantly more complex and noisy than simulated contexts. This also acts as a final validation against what has been reported in the literature.

Importantly, we find that our results from the simulation study are largely corroborated for empirical returns data.

\subsection{Data}

\rhs{reorganise such that it's get returns data, then find the factor set for it. Not actually what we did, but flows better}
...
\rhs{structure is a little weird here regarding neural networks}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[max size = {\textwidth}{0.5\textheight}]{empirical_test_mse}
	\end{center}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[max size = {\textwidth}{0.5\textheight}]{empirical_test_mae}
	\end{center}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[max size = {\textwidth}{0.5\textheight}]{empirical_sample_all_vi_ind}
...
\begin{figure}[!htb]
	...
	\begin{center}
		\includegraphics[max size = {\textwidth}{0.5\textheight}]{empirical_sample_all_vi_macro_facet}
...
\begin{figure}[!htb]
	\includegraphics[max size = {\textwidth}{0.5\textheight}]{eln_alpha_plot.pdf}
...
\begin{figure}[!htb]
	\includegraphics[max size = {\textwidth}{0.5\textheight}]{eln_lambda_plot.pdf}
...
\begin{figure}[!htb]
	\includegraphics[max size = {\textwidth}{0.5\textheight}]{rf_mtry_plot.pdf}
...
\begin{figure}[!htb]
	\includegraphics[max size = {\textwidth}{0.5\textheight}]{rf_nodesize_plot.pdf}
