...
Literature has shown that a lot of these techniques show promise, and in some papers, outperform quite consistently

\cite{hsu_finding_2014}
...
$T = 180$ monthly periods corresponds to 15 years. The training sample was set to start from $T = 108$ or 9 years, a validation set 1 year in length. The last 3 years were reserved as a test set never to be use for validation or training.
