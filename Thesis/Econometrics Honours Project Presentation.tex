...
Able to capture non-linearities automatically and systematically
\end{frame}
...
Neural Networks have the largest number of hyperparameters to tune - computationally infeasible to conduct comprehensive grid search. Conservative gridsearch was conducted, but it was observed that in general, default values provided the best performance.
...
Construct 8 macroeconomic factors, (\cite{welch_comprehensive_2008}):
...
Important, as this suggests that the simulation study was accurate to some degree, and there is some support for the same conclusions to be made.
