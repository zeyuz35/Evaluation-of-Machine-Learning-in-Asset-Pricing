...
%	\caption{Missing Data Threshold Robustness Check Indiviudal Factor Importance}
%\end{figure}
%
%\begin{figure}
...
\begin{figure}
	...
	\caption{{Train:Validation = 1:1 Robustness Check Indiviudal Factor Importance}
\end{figure}
